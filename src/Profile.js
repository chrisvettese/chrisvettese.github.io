    ...
    return (
        <Grid container justify="space-between">
            <Grid item>
                <Grid container>
                    <Grid item>
                        <img src={profileImage} className={classes.profile} alt="Profile"/>
                    </Grid>
                    <Grid item>
            ...
            <Grid item>
                <div className={classes.socialMedia}>
                    <Grid container>
                        <a target="_blank" href="https://github.com/chrisvettese/" rel="noreferrer">
                    ...
                    <Grid container>
                        <a target="_blank" href="https://www.linkedin.com/in/christopher-vettese/" rel="noreferrer">
