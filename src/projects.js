...
const languages = [[javaIcon, "Java"], [javascriptIcon, "JavaScript"], [reactIcon, "React"], [androidIcon, "Android"]];

//format for links: ["", "", ""] -> [app demo link, github link, devpost link]. empty quotes when app doesn't have a link
